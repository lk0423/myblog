    ...
    function putInArticle(data) {
        ...
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '</div>');
        $('.lk-article-top').append(articleTop);
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="https://lk-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/weixin.jpg">' +
            '</p>' +
            ...
            '</span>' +
            '</div>');
        $('.lk-article-footer').append(articleFooter);
    ...
    $.ajax({
        ...
        success:function (data) {
            if(data.status == "200"){
                ...
                $('.content').html('');
                var error = $('<div class="article"><div class="lk-article-top"><div class="error">' +
                    '<img src="https://lk-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/register_success.jpg">' +
                    '<p>没有找到这篇文章哦</p>' +
                    '<p>可能不小心被博主手残删掉了吧</p>' +
                    '<div class="row">' +
                    '<a href="/">返回首页</a>' +
